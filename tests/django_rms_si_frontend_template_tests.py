...
class RmsSiFrontendTemplateTests(SimpleTestCase):
    ...
    def test_idea_editor_uses_exact_source_version_not_source_id(self):
        html = render_to_string("rms/idea_editor.html", {"api_url":"/api/v1/ideas", "correction":False, "idea_fields": [{"name":"title", "label":"Title", "required":True}], "source_versions":[SOURCE], "contributions":[{}]})
